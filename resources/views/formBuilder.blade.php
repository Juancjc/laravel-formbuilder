...
<body class="antialiased">
    <form id="myForm" action="{{ route('formulario.store') }}" method="POST">
        @csrf


        <button type="submit">Enviar</button>

        <a type="button" href="">Enviar</a>
        <input type="text" class="form-control" id="useremail" value="testeRequest" name="testeRequest"
            placeholder="testeRequest" autofocus>
        <div
    ...
    <script>
        jQuery(function($) {
            ...
            $('.edit-form', $formContainer).click(function() {
                ...
                // Quando estiver pronto para enviar o formulário
                document.getElementById('myForm').submit();

            });
            $('.teste', $formContainer).click(function() {
                $fbEditor.toggle();
                $formContainer.toggle();
                var formData = formBuilder.actions.getData('json');
